...
q_prompt = f"""
Context: {game_lore}
You are {npc1_name}. You want to mine some mithril ore but don't know level requirements.
Ask {npc2_name} a specific question about the level restrictions on mining mithril ore.
Keep it casual for {npc1_name}, but {npc2_name} is a bit abbrasive about the answer.
"""
